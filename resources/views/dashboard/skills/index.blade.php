                    ...
                    @foreach ($skills as $skill)
                      <tr>
                        ...
                        <td class="td-actions text-right">
                          <a href=" {{route('skills.edit', $skill->id)}} " rel="tooltip" class="btn btn-white btn-link btn-sm" data-original-title="Edit skill">
                            <i class="material-icons">edit</i>
                          </a>
                          <form action="{{ route('skills.destroy', $skill->id )}}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" rel="tooltip" class="btn btn-white btn-link btn-sm" data-original-title="Delete skill">
