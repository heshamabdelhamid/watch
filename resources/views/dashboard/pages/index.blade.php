                    ...
                    @foreach ($pages as $page)
                      <tr>
                        ...
                        <td class="td-actions text-right">
                          <a href=" {{route('pages.edit', $page->id)}} " rel="tooltip" class="btn btn-white btn-link btn-sm" data-original-title="Edit page">
                            <i class="material-icons">edit</i>
                          </a>
                          <form action="{{ route('pages.destroy', $page->id )}}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" rel="tooltip" class="btn btn-white btn-link btn-sm" data-original-title="Delete page">
